...
export class OrgaoApreensaoController {
    async create(req: Request, res: Response) {
        ...
        try {
            ...
            return res
                .status(400)
                .json({ error: 'Não foi possível cadastrar o órgão de apreensão.' });
        }
    }
    ...
    async list(req: Request, res: Response) {
        try {
            ...
            return res
                .status(400)
                .json({ error: 'Não foi possível listar os órgãos de apreensão.' });
        }
    }
    ...
    async update(req: Request, res: Response) {
        ...
        try {
            ...
            return res
                .status(400)
                .json({ error: 'Não foi possível atualizar o órgão de apreensão.' });
        }
    }
    ...
    async delete(req: Request, res: Response) {
        ...
        try {
            ...
            return res
                .status(400)
                .json({ error: 'Não foi possível excluir o órgão de apreensão.' });
        }
    }
}